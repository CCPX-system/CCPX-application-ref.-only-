...
function validateUsername() {
	 ...
	 */
	$.ajax({
		url:"ajaxUsername",//要请求的url
		data:{method:"ajaxValidateLoginname", username:value},//给服务器的参数
		type:"POST",
		dataType:"json",
...
function validateVerifyCode() {
	 ...
	 */
	$.ajax({
		url:"ajaxVerifycode",//要请求的servlet
